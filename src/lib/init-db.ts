...
const STATEMENTS = [
  ...
  `CREATE TABLE IF NOT EXISTS \`Course\` (
    ...
    \`showRegistrationGuide\` TINYINT(1) NOT NULL DEFAULT 0,
    \`registrationGuidePosition\` VARCHAR(191) NOT NULL DEFAULT 'afterPayment',
    \`showSchedule\` TINYINT(1) NOT NULL DEFAULT 0,
    \`scheduleTitle\` VARCHAR(191) NOT NULL DEFAULT '',
    \`scheduleUrl\` TEXT NULL,
    \`schedulePosition\` VARCHAR(191) NOT NULL DEFAULT 'afterPayment',
  ...
  "ALTER TABLE `Course` ADD COLUMN IF NOT EXISTS `showRegistrationGuide` TINYINT(1) NOT NULL DEFAULT 0",
  "ALTER TABLE `Course` ADD COLUMN IF NOT EXISTS `registrationGuidePosition` VARCHAR(191) NOT NULL DEFAULT 'afterPayment'",
  "ALTER TABLE `Course` ADD COLUMN IF NOT EXISTS `showSchedule` TINYINT(1) NOT NULL DEFAULT 0",
  "ALTER TABLE `Course` ADD COLUMN IF NOT EXISTS `scheduleTitle` VARCHAR(191) NOT NULL DEFAULT ''",
  "ALTER TABLE `Course` ADD COLUMN IF NOT EXISTS `scheduleUrl` TEXT NULL",
  "ALTER TABLE `Course` ADD COLUMN IF NOT EXISTS `schedulePosition` VARCHAR(191) NOT NULL DEFAULT 'afterPayment'",
